...
public class SearchVideosAdapter extends RecyclerView.Adapter<SearchVideosAdapter.TopViewHolder>{


    Context context;
    List<SearchModel> list;

    public SearchVideosAdapter(Context context, List<SearchModel> list) {
    ...
    public void onBindViewHolder(@NonNull TopViewHolder holder, int position) {
       ...
       // Picasso.get().load(Constant.Image_URL+list.get(position).getImage()).into(holder.cover_image);
        ...
        String s = list.get(position).getUpdatedAt();
        String[] s2 = s.split("T");
   ...
   /* public void addAllResult(List<VideoDataModel.Datum> list){
