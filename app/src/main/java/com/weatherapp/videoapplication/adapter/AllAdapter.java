...
public class AllAdapter extends RecyclerView.Adapter<AllAdapter.TopViewHolder>{
   ...
   onClickInterface onClickInterface;
    ...
    public AllAdapter(Context context, List<VideoDataModel.Datum> list,onClickInterface onClickInterface) {
    ...
    public void onBindViewHolder(@NonNull TopViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickInterface.setClick(list.get(position).getLink());
            }
        });
