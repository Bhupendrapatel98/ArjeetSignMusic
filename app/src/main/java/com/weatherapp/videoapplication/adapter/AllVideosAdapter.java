...
public class AllVideosAdapter extends RecyclerView.Adapter<AllVideosAdapter.TopViewHolder>{


    Context context;
    List<VideoDataModel.Datum> list;

    public AllVideosAdapter(Context context, List<VideoDataModel.Datum> list) {
